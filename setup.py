...
curr_dir = os.path.abspath('opencv_base')
...
def get_py(base_path=os.path.abspath('opencv_base'), parent_path='', name='', excepts=(), copyOther=False, delC=False):
    """
    获取py文件的路径
    :param base_path: 根路径
...
def remove_file():
    ...
    """
    for root, dirs, files in os.walk('opencv_base'):
